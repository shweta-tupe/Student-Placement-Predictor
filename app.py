...
sql = st.slider("SQL Score", min_value=0, max_value=100, value=50)
...
readiness = st.number_input("Placement Readiness Score(1-100)", min_value=0, max_value=100, step=1)
